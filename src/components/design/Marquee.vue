<template>
  <section
    id="marquee-section"
    class="text-flax-smoke-200 relative mb-20 flex h-40 w-full flex-col justify-center overflow-clip leading-none will-change-auto sm:mb-50 sm:h-64"
  >
    <div
      id="marquee-1"
    ...
    >
      <h4
        ...
        :id="`marquee-item-${_}`"
        :key="`marquee-item-${_}`"
        class="sm:heading-1 flex w-fit items-center text-3xl font-bold text-nowrap whitespace-nowrap max-sm:mx-10"
      >
        Visual Storyteller
