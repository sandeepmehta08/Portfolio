  ...
  >
    ...
    >
      ...
      <div class="flex-center z-10 flex-col gap-y-8">
        ...
        ></h3>
        <div
          class="mt-[2%] flex scale-150 items-center lg:scale-[1.5] xl:scale-[2.5] 2xl:scale-[3]"
        >
          <!-- <Button
            ...
            label="Get in touch"
          /> -->
          <Button label="Get in touch" url="https://wa.me/917378159353" />
        </div>
      </div>
      <div
      ...
      >
        ...
        <div class="heading-6 flex w-full flex-col items-center text-center text-flax-smoke-500 md:w-fit md:items-end md:text-right">
          <p class="w-full font-bold uppercase">For further inquiries</p>
          <Link
            class="text-flax-smoke-300 h-6 max-w-full truncate text-[3.2vw] font-medium tracking-wider lowercase sm:text-base md:text-sm lg:text-base"
            label="sandeepmehta2508.connect@gmail.com"
            :icon="true"
            url="mailto:sandeepmehta2508.connect@gmail.com"
          />
        </div>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  const makeItHappen = ref("LET’S CREATE SOMETHING THAT LASTS");
  onBeforeMount(() => {
